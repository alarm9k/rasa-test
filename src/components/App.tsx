    ...
    render() {
        return (
            <div style={styles.app}>
                ...
                <section>
                    <p>
                        Rasa is writing a new natural language classifier to sort useful concepts in tech from
                        meaningless jargon{' '}
                        <span role="img" aria-label="Hell yeah">
                            💯
                        </span>
                        . You are writing the interface to help us train the classifier! One of the important parts of
                        the interface is what we call the EntityHighlighter, which allows the user to highlight and
                        identify parts of a string. Try clicking existing highlights, or adding some of your own by
                        selecting some text and filling the form.
                    </p>
                    <p>
                        ...
                        everyone is afraid of touching it! Your task is to refactor <code>EntityHighlighter.js</code>{' '}
